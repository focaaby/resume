...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Jerry}{Wang}{ \urlstyle{same}\href{https://focaaby.github.io/}{focaaby.github.io/}\\
...
\runsubsection{IoT 2.0 smart application platform}
\descript{| Foxlink FPC}
...
\descript{Team: Hsieh-Jia-Ko, 1st place}
