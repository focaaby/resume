...
\runsubsection{\urlstyle{same}\href{https://hktw-resources.awscloud.com/aws-devax-amazon-eks}{AWS 現代應用開發賦能系列 — Amazon EKS 與現代化應用管理者實踐}}
...
\descript{AWS User Group Taiwan - 台中}
